...
public class Spiller {
    ...
    private static void spillInPlace(int x, int y, int spillMass_kg, int iter_num)
    {
        ...
        for (int i = 0; i < OPamt; i++) {
            ...
            new OilParticle(x_m, y_m, iter_num); //FIXME: Refactor via factory method.
        }
    }
}
